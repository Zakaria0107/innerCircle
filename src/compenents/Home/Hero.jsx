  ...
  return (
    <div className='w-screen  h-[450px] sm:min-h-[600px] xl:min-h-[875px] bg-hero-home bg-center bg-cover bg-no-repeat '>
        <div className='w-[92%] xl:w-[86%] h-full mx-auto flex justify-center items-center flex-col'>
            ...
            <p className='max-w-[977px] mt-3 xl:mt-[66px] font-normal leading-[15px] sm:leading-[18px] md:leading-[24px] text-xs sm:text-sm md:text-base xl:text-lg text-center text-[#F9F7FA]'>Access top-tier global hires with Inner Circle Talent, your ally in acquiring top-tier executive assistant, virtual assistant, and marketing professionals at a fraction of the US cost. Specializing in sourcing and recruiting exceptional talent globally at competitive rates, we ensure a perfect match and new hire onboarding through deeply understanding you and your company's needs, stringent vetting and post-hire support and feedback for both candidates and hiring managers. </p>
            <a href="/contact">
