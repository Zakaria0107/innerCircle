  ...
  return (
    <div className='w-screen'>
        <div className='w-[92%] xl:w-[86%] mx-auto py-[40px] md:py-[50px] lg:py-[70px] xl:py-[98px]'>
            ...
            <div className='mt-8 flex justify-center items-center w-full gap-10 sm:gap-20 flex-wrap'>
                ...
                <div className='max-w-[280px] flex justify-center items-center flex-col'>
                    ...
                    <p className='text-center font-semibold text-[10px] sm:text-base leading-3 sm:leading-5'>That delegation to trusted employees allows executives and leaders to concentrate on their most impactful work, knowing that their vision is being amplified.</p>
                </div>
            </div>
