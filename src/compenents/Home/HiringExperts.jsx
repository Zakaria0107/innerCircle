...
const HiringExperts = () => {
  return (
    <div className='w-screen relative'>
        <img src={hiringExpertsImg} alt="" className='w-full lg:w-auto !h-full absolute left-0 top-0  -z-10  ' />
