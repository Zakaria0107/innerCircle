            ...
            <div className='max-w-[934px] mx-auto'>
                <div className='flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-2 sm:gap-9 mb-[72px] '>
                    ...
                    <div className='text-center lg:text-justify max-w-[596px] '>
                        <h4 className='font-gothic-a1 font-bold text-xs sm:text-base md:text-xl lg:text-[28px] leading-[36px] text-[#0C0405]'>Ahmed Bani</h4>
                ...
                <div className='flex flex-col-reverse lg:flex-row justify-center lg:justify-between items-center gap-2 sm:gap-9 mb-[72px]'>
                    <div className='text-center lg:text-justify max-w-[596px] '>
                        ...
                        <p className='text-xs sm:text-sm md:text-base xl:text-lg leading-[23px] text-[#5B5B5B]'>Elsa was previously EA to the President of the Court in Mexico City as well as the Mexican Ambassador to the Netherlands. Following her career in public service, she led the expansion of a beauty Ecom company into Mexico, building out their customer service and ultimately managing CS teams across South America.</p>
                    </div>
